...
<div class="span3"> 
    ...
    <div class="span4">
      <form name="form_login" class="login-form normal-font" action="/bonusPointsExchange/actionServlet" method="post" onsubmit="return checkForm();">
       ...
       <div class="mes" style="font-size:15px;"><a href="regist.jsp">Sign up for free</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/bonusPointsExchange/retrievePassword_1.jsp?method=forgetPasswd_user">Forgot password?</a>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; </div>
